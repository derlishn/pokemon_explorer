...
class SettingsPage extends GetView<SettingsController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(TranslationKeys.settings.tr, style: const TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
      ),
      body: AdaptiveLayout(
          ...
          child: Column(
            children: [
              ...
              Wrap(
                ...
                runSpacing: 24,
                children: [
                  _buildSectionBox(context, TranslationKeys.theme.tr, 450, [
                    _buildThemeToggle(),
                    const SizedBox(height: 8),
                    _buildAccentColorPicker(context),
                  ]),
                  _buildSectionBox(context, TranslationKeys.storage.tr, 450, [
                  ...
                  _buildSectionBox(context, TranslationKeys.language.tr, 450, [
  ...
  Widget _buildCacheToggle(BuildContext context) {
    return ListTile(
      ...
      subtitle: Text(TranslationKeys.useCacheDesc.tr, style: const TextStyle(fontSize: 12)),
      trailing: Obx(() => Switch.adaptive(
  ...
  Widget _buildClearCacheButton(BuildContext context) {
    return ListTile(
      ...
      subtitle: Text(TranslationKeys.clearCacheDesc.tr, style: const TextStyle(fontSize: 12)),
