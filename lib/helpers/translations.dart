...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'cache_warning_msg': 'The app will need to download data from the internet every time, which will be slower and consume more data.',
    'clear_cache_confirm_title': 'Clear Cache',
    'clear_cache_confirm_msg': 'You are about to delete @count cached Pokémon. Are you sure?',
    'cancel': 'Cancel',
    'confirm': 'Confirm',
    'disable': 'Disable',
    'delete': 'Delete',
    ...
    'cache_warning_msg': 'La aplicación tendrá que descargar los datos de internet cada vez, lo que será más lento y consumirá más datos.',
    'clear_cache_confirm_title': 'Borrar Caché',
    'clear_cache_confirm_msg': 'Estás a punto de borrar @count Pokémon en caché. ¿Estás seguro?',
    'cancel': 'Cancelar',
    'confirm': 'Confirmar',
    'disable': 'Desactivar',
    'delete': 'Eliminar',
